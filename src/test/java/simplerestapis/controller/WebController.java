 ...
 * 
 * @RequestMapping("/sample") public SampleResponse Sample(@RequestParam(value =
 * "name", defaultValue = "Robot") String name) { SampleResponse response = new
 * SampleResponse(); response.setId(1);
